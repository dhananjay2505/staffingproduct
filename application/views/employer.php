...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-7 float-left col-12 common_box mt_30">
            ...
            <h1 class="section_title mt_20 mb_20 w-100">Register your business account</h1>
            <div class="row">

            <?php
            $attributes = array('id' => 'myform');
            echo form_open('/register-business/', $attributes); ?>
            ...
            <span class="w-100 float-left pb_10">
                Have an account?<a href="<?php echo base_url('')."login-business"; ?>" class="pl_20">Login in</a> 
            </span>
        </form>
