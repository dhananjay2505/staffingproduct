...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-5 float-left col-12 common_box mt_30">
            ...
            <h1 class="section_title col-md-12 mt_20 mb_20">Login to your business account</h1>
            

            <?php
            $attributes = array('id' => 'loginform');
            echo form_open('/login-business/', $attributes); ?>
                ...
                <div class="col-md-12 float-left col-12 ">
                    <input type="submit" id="pwdclick" name="businessign" class="primary_btn w-100" value="Sign in">
                </div>
                <div class="col-md-12 float-left col-12 ">
                ...
                <?php echo form_open('/business-login-otp/');?>
                <div class="col-md-12 float-left col-12" id="loginwithotp">
                    <input type="submit" id="businessotpclick" name="otppage" class="second_btn w-100" value="Login with OTP" >
                </div>
            </form>
                <span class="w-100 float-left pt_20 pb_10">
                    New to Adishi?<a href="<?php echo base_url('register-business/') ?>" class="pl_10">Join now</a> 
                </span>
...
$(document).ready(function(){
    $("#businessotpclick").click(function(){
        window.location.href == '<?php echo base_url('/business-otp-login/'); ?>'
    });
});    
</script>